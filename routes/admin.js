...
router.get("/createGrad", (req, res) => {
    res.render("admin/createGrad")
})

router.get("/createProizvod", (req, res) => {
...
router.post("/createGrad/save", require("../controllers/admin/createGrad"));

router.post("/createProizvod/save", require("../controllers/admin/createProizvod"));
